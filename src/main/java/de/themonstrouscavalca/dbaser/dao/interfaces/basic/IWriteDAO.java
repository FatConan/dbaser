...
public interface IWriteDAO<T>{
    ResponseOrError<T> save(T entity, PersistenceExecutor<T> executorCall, boolean forceInsert);
    ResponseOrError<T> save(Connection connection, T entity, PersistenceExecutor<T> executorCall, boolean forceInsert);
